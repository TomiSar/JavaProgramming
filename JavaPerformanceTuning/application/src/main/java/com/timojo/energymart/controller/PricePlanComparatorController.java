...
public class PricePlanComparatorController {
    ...
    private final Counter notFoundCouter;
    ...
    public PricePlanComparatorController(PricePlanService pricePlanService, Accounts accounts, MeterRegistry meterRegistry) {
        ...
        this.responseTimer = meterRegistry.timer("plans.recommend.responsetTime");
        this.notFoundCouter = meterRegistry.counter("plans.recommend.notFoundCount");
    }
